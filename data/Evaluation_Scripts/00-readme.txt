...
scores for each timeline. By default the evaluation script takes
...
For example
   ...
   FSCORE:61.1223	steve_jobs.txt
   FSCORE:81.4815	ipod.txt
   FSCORE:72.7273	iphone_3g.txt
   FSCORE:77.135	itunes_store.txt
   FSCORE:92.3077	beatles_apple_corps.txt
   FSCORE:82.0144	iphone_4.txt
   MICRO-FSCORE:68.7484389831
...
For example:
  ...
  The F-score of the timeline is stored in the tmp_dir/tmp.out file:
  76.4706 
